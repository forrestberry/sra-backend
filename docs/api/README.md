...
- **Math Facts Trainer**: `docs/api/math_facts_sessions.md` documents the session RPCs and `docs/api/math_facts_reporting.md` covers mastery/recent-miss reporting calls.
